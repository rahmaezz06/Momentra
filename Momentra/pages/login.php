  ...
  <div class="auth-card">
    ...
    <form method="POST">
      ...
      <div class="form-group">
        ...
        <a href="<?= BASE_URL ?>/pages/forgot-password.php" class="forgot-link">Forgot password?</a>
      </div>
      <button type="submit" class="btn-primary">Log In</button>
    </form>
    <div class="divider">or</div>
    <div class="auth-footer">Don't have an account? <a href="<?= BASE_URL ?>/pages/register.php">Sign up</a></div>
  </div>
</div>
<script>
function togglePw() {
