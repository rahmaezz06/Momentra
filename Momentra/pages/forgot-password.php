...
<style>
:root{ 
  --bg:#0b1020; --surface:#131929; --card:#1a2236; --border:#2d3a55;
  --text:#f8fafc; --muted:#8899bb; --accent:#6366f1; --accent2:#8b5cf6;
...
.auth-card{
  ...
  border-radius:20px; padding:34px 32px; box-shadow:0 24px 60px #00000055;
}
...
.form-group input{
  ...
  border-radius:10px; padding:12px 14px; color:var(--text); font-family:inherit;
...
.alert-error{
  background:#6366f115; border:1px solid #ef444440; color:#fca5a5;
  padding:12px 16px; border-radius:10px; margin-bottom:18px; font-size:.875rem;
}
.alert-success{
  background:#10b98115; border:1px solid #10b98140; color:#6ee7b7;
  padding:16px; border-radius:10px; margin-bottom:18px; font-size:.875rem; line-height:1.6;
}
.alert-dev{
  background:#f59e0b10; border:1px solid #f59e0b35; color:#fcd34d;
  padding:14px 16px; border-radius:10px; margin-top:12px; font-size:.82rem; line-height:1.7;
}
.alert-dev strong{ display:block; margin-bottom:6px; font-size:.78rem; text-transform:uppercase; letter-spacing:.06em; opacity:.65; }
.alert-dev a{ color:#a5b4fc; font-weight:600; word-break:break-all; }
.back-link{
  display:flex; align-items:center; gap:6px; color:var(--muted);
  text-decoration:none; font-size:.875rem; margin-bottom:22px; transition:color .2s;
}
.back-link:hover{ color:var(--text); }
.spinner{
  display:none; width:16px; height:16px; border:2px solid #ffffff44;
  border-top-color:#fff; border-radius:50%; animation:spin .6s linear infinite; margin-right:8px;
}
